...
export default defineConfig({
  ...
  webServer: [
    { command: "python -m uvicorn app.main:app --host 127.0.0.1 --port 8015 --no-access-log", cwd: "../api", url: "http://127.0.0.1:8015/health", timeout: 60000, env: { DATABASE_URL: `sqlite:///${database}`, BOOTSTRAP_ADMIN_USERNAME: "browser-admin", BOOTSTRAP_ADMIN_PASSWORD: "browser-test-password", PAN_HASH_SECRET: "browser-test-only" } },
